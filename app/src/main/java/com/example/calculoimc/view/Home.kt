...
import com.example.calculoimc.datasource.Calculations
import com.example.calculoimc.ui.theme.Blue
import com.example.calculoimc.ui.theme.Red
import com.example.calculoimc.ui.theme.White
        ...
        Column(
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    modifier = Modifier.fillMaxWidth(0.4f).padding(start = 20.dp, end = 20.dp),
                ...
                OutlinedTextField(
                    ...
                    modifier = Modifier.fillMaxWidth(0.7f).padding(start = 20.dp, end = 20.dp),
                    keyboardOptions = KeyboardOptions(
            ...
            Button(
                onClick = {
                    Calculations.calculateIMC(height = height, weight =  weight,
